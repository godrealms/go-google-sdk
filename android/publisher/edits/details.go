...
// DetailsGet wraps androidpublisher.Edits.Details.Get.
...
// DetailsPatch wraps androidpublisher.Edits.Details.Patch (partial update).
...
// DetailsUpdate wraps androidpublisher.Edits.Details.Update (full replacement).
